...
function Home() {
  ...
  <div className="banner">
		<div className="container">
			<h3>SuperMarket , <span>Special Offers</span></h3>
		</div>
	</div>
									...
									productList.map((product)=>(
										...
										<div className="col-md-4 agile_ecommerce_tab_left">
											<div className="hs-wrapper">
												<img src={product.image_url} alt=" " className="img-responsive" />
	...
	<div className="newsletter">
		<div className="container">
			<div className="col-md-6 w3agile_newsletter_left">
				<p className="text-feat">"Send Us Your Email-ID to get daily wise offer Updates"</p>
