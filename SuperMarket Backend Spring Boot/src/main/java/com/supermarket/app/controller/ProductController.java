...
public class ProductController {
	...
	@RequestMapping("getProductsById/{productId}")
	public Products getProductsById(@PathVariable String productId) throws Exception{
		return this.ProductServices.getProductsById(Long.parseLong(productId));
	}
